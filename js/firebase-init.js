...
const BRANCHES = {
  "1": {
    ...
    location: "بنفسج 4 - بنفسج 2",
    locationEn: "First Settlement, Banafseg 4",
    // ملحوظة: لينك مبني تلقائي من عنوان الفرع، بيشتغل فورًا. لو عايز البن يظبط
    // بالظبط 100% على نقطة الفرع نفسه: من Google Maps دوس على الفرع -> Share ->
    // Embed a map -> انسخ اللي جوا src="..." وحطه هنا بدل اللينك ده.
    locationMapUrl:
  ...
  "5": {
    ...
    // ملحوظة: لينك maps.app.goo.gl القصير ده لينك تحويل (redirect) بس، ومينفعش يتحط جوا iframe مباشرة.
    // اللينك تحت شغال فورًا وبيوري نفس المكان (مبني من عنوان الفرع). لو عايز البن يظبط بالظبط 100%
    // على نقطة الفرع نفسه: من Google Maps دوس على الفرع -> Share -> Embed a map -> انسخ اللي جوا src="..." وحطه هنا.
    locationMapUrl:
      "https://www.google.com/maps?q=" +
