...
// 8) عشان الإشعارات (Push Notifications) تشتغل حتى لو التطبيق مقفول:
//    Project settings -> Cloud Messaging -> تبويب "Web configuration" ->
//    تحت "Web Push certificates" دوس Generate key pair، وانسخ الـ
//    "Key pair" (يبدأ بحروف وأرقام طويلة) وحطه هنا في VAPID_KEY تحت.
//    الشرح بالتفصيل في SETUP.md.
// ============================================================
...
// مفتاح الـ Web Push (VAPID) بتاع Cloud Messaging — لازم تحطه عشان الإشعارات تشتغل
