    ...
    <div class="option-box">
      ...
      <div class="field">
        ...
        <div class="payment-method-grid">
          ...
          <button type="button" class="glass-btn-secondary glass-btn tap-fx payment-method-btn" data-payment="فيزا">💳 فيزا</button>
        </div>
      </div>
      <div class="field">
...
async function submitOrder() {
  ...
  if (!/^[0-9]{11}$/.test(phoneRaw)) {
    errEl.textContent = "من فضلك اكتب رقم موبايل صحيح (11 رقم)";
    return;
  }
