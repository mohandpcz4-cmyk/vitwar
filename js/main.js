...
const SEED_REVIEWS = [
  ...
  { name: "Karim Hossam", stars: 5, textAr: "بجد بحب الفانيليا لاتيه بتاعهم، طلبت أكتر من مرة", textEn: "I really love their vanilla latte, ordered more than once", daysAgo: 21 },
  ...
  { name: "Sherif Adham", stars: 5, textAr: "بجد بحب المشروبات بتاعتهم، طلبت أكتر من مرة ومحصلش خيبة أمل", textEn: "I really love their drinks, ordered many times and never disappointed", daysAgo: 180 },
  ...
  { name: "Jihad Adel", stars: 5, textAr: "جربت الكابتشينو والتشيز كيك وكانوا رائعين", textEn: "Tried the cappuccino and cheesecake, both were fantastic", daysAgo: 4 },
  ...
  { name: "Peter Nabil", stars: 5, textAr: "الحلويات هنا مالهاش حل، خصوصاً التيراميسو", textEn: "The desserts here are unbeatable, especially the tiramisu", daysAgo: 4 },
  ...
  { name: "Verina Nabil", stars: 5, textAr: "القهوة بتاعتهم من أحلى قهوة شربتها في حياتي", textEn: "Their coffee is some of the best I've ever had", daysAgo: 90 },
  ...
  { name: "Mostafa Adel", stars: 5, textAr: "المشروبات الباردة منعشة جداً في الصيف", textEn: "The cold drinks are super refreshing in summer", daysAgo: 4 },
  ...
  { name: "فريدة محمد", stars: 5, textAr: "المكان تحفة والطلبات بتوصل بسرعة، تجربة رهيبة 😍", textEn: "Lovely place, orders arrive fast — amazing experience 😍", daysAgo: 180 },
  { name: "Dalia Fouad", stars: 5, textAr: "أحسن مطعم وافل وبان كيك جربته من ناحية الطعم والخدمة", textEn: "Best waffle & pancake restaurant I've tried in terms of taste and service", daysAgo: 4 },
  { name: "هدير مصطفى", stars: 5, textAr: "بجد بحب المشروبات بتاعتهم، طلبت أكتر من مرة ومحصلش خيبة أمل", textEn: "I really love their drinks, ordered many times and never disappointed", daysAgo: 21 },
  { name: "Peter Nabil", stars: 5, textAr: "خدمة سريعة واهتمام بالتفاصيل، شكراً فيتوار ❤", textEn: "Fast service and attention to detail, thank you Vitwar ❤", daysAgo: 90 },
  { name: "جهاد عادل", stars: 5, textAr: "من أفضل تجارب التوصيل اللي جربتها، هطلب تاني أكيد", textEn: "One of the best delivery experiences I've had, will order again for sure", daysAgo: 180 },
  { name: "Verina Nabil", stars: 5, textAr: "المكان نضيف والطاقم لطيف جداً ومحترم", textEn: "The place is clean and the staff are very kind and respectful", daysAgo: 4 },
  { name: "Mostafa Adel", stars: 5, textAr: "الطعم فوق الوصف، والتغليف أنيق جداً", textEn: "The taste is beyond words, and the packaging is very elegant", daysAgo: 21 },
  { name: "Rana Magdy", stars: 5, textAr: "جربت الكابتشينو والتشيز كيك وكانوا رائعين", textEn: "Tried the cappuccino and cheesecake, both were fantastic", daysAgo: 90 },
  { name: "Sherif Adham", stars: 5, textAr: "سعر مناسب مقابل الجودة العالية اللي بتقدمها", textEn: "Fair price for the high quality they offer", daysAgo: 180 },
  { name: "Farida Mohamed", stars: 5, textAr: "فريق العمل بشوش ومتعاون جداً، تجربة ممتعة", textEn: "The staff are friendly and cooperative, a delightful experience", daysAgo: 4 },
  { name: "Dalia Fouad", stars: 5, textAr: "الطلب وصل ساخن ومظبوط في معاده بالظبط", textEn: "The order arrived hot and right on time", daysAgo: 21 },
  { name: "Hedeer Mostafa", stars: 5, textAr: "مكاني المفضل للقعدة مع صحابي، الجو حلو أوي", textEn: "My favorite spot to hang out with friends, the vibe is amazing", daysAgo: 90 },
  { name: "Peter Nabil", stars: 5, textAr: "لسه بجرب حاجات جديدة من المنيو وكل حاجة بتعجبني", textEn: "Still trying new items from the menu and loving everything", daysAgo: 180 },
  { name: "Jihad Adel", stars: 5, textAr: "تصميم المكان جميل والإضاءة مريحة جداً للعين", textEn: "The place design is beautiful and the lighting is very comfortable", daysAgo: 4 },
  { name: "Verina Nabil", stars: 5, textAr: "خدمة العملاء ردت عليا بسرعة وحلت مشكلتي فوراً", textEn: "Customer service replied quickly and solved my issue instantly", daysAgo: 21 },
  { name: "Mostafa Adel", stars: 5, textAr: "الحلويات هنا مالهاش حل، خصوصاً التيراميسو", textEn: "The desserts here are unbeatable, especially the tiramisu", daysAgo: 90 },
  { name: "رنا مجدي", stars: 5, textAr: "بطلب منهم كل أسبوع، جودة ثابتة من غير ما تقل", textEn: "I order from them every week, consistent quality that never drops", daysAgo: 180 },
  { name: "Sherif Adham", stars: 5, textAr: "القهوة بتاعتهم من أحلى قهوة شربتها في حياتي", textEn: "Their coffee is some of the best I've ever had", daysAgo: 4 },
  { name: "فريدة محمد", stars: 5, textAr: "التطبيق سهل الاستخدام والطلب بياخد ثواني بس", textEn: "The app is easy to use and ordering takes just seconds", daysAgo: 21 },
  { name: "Dalia Fouad", stars: 5, textAr: "عندهم عروض حلوة ومتجددة باستمرار", textEn: "They have great and constantly updated offers", daysAgo: 90 },
  { name: "هدير مصطفى", stars: 5, textAr: "التوصيل كان أسرع من المتوقع بكتير", textEn: "Delivery was much faster than expected", daysAgo: 180 },
  { name: "Peter Nabil", stars: 5, textAr: "جو المكان يخلي أي زيارة تبقى مميزة", textEn: "The atmosphere makes every visit feel special", daysAgo: 4 },
  { name: "جهاد عادل", stars: 5, textAr: "أول مرة أزور وحبيت التجربة من كل النواحي", textEn: "First visit and I loved the experience in every way", daysAgo: 21 },
  { name: "Verina Nabil", stars: 5, textAr: "النكهات مبتكرة وفيها لمسة مختلفة عن أي مكان تاني", textEn: "The flavors are creative with a unique twist you won't find elsewhere", daysAgo: 90 },
  { name: "Mostafa Adel", stars: 5, textAr: "عيلتي كلها بقت بتطلب من هنا بقالها شهور", textEn: "My whole family has been ordering from here for months", daysAgo: 180 },
  { name: "Rana Magdy", stars: 5, textAr: "الأسعار معقولة جداً بالنسبة لجودة المنتج", textEn: "Very reasonable prices for the product quality", daysAgo: 4 },
  { name: "Sherif Adham", stars: 5, textAr: "حبيت إنهم بيردوا بسرعة على أي استفسار", textEn: "I loved how quickly they respond to any inquiry", daysAgo: 21 },
  { name: "Farida Mohamed", stars: 5, textAr: "المشروبات الباردة منعشة جداً في الصيف", textEn: "The cold drinks are super refreshing in summer", daysAgo: 90 },
  { name: "Dalia Fouad", stars: 5, textAr: "تجربة تستاهل كل نجومها، هرجع تاني أكيد", textEn: "An experience that deserves every star, I'll definitely be back", daysAgo: 180 },
  { name: "Hedeer Mostafa", stars: 5, textAr: "بصراحة فاق توقعاتي، وربنا يوفقهم دايماً", textEn: "Honestly exceeded my expectations, wishing them continued success", daysAgo: 4 },
  { name: "Peter Nabil", stars: 5, textAr: "المكان تحفة والطلبات بتوصل بسرعة، تجربة رهيبة 😍", textEn: "Lovely place, orders arrive fast — amazing experience 😍", daysAgo: 21 },
  { name: "Jihad Adel", stars: 5, textAr: "أحسن مطعم وافل وبان كيك جربته من ناحية الطعم والخدمة", textEn: "Best waffle & pancake restaurant I've tried in terms of taste and service", daysAgo: 90 },
  { name: "Verina Nabil", stars: 5, textAr: "بجد بحب المشروبات بتاعتهم، طلبت أكتر من مرة ومحصلش خيبة أمل", textEn: "I really love their drinks, ordered many times and never disappointed", daysAgo: 180 },
  { name: "Mostafa Adel", stars: 5, textAr: "خدمة سريعة واهتمام بالتفاصيل، شكراً فيتوار ❤", textEn: "Fast service and attention to detail, thank you Vitwar ❤", daysAgo: 4 },
  { name: "رنا مجدي", stars: 5, textAr: "من أفضل تجارب التوصيل اللي جربتها، هطلب تاني أكيد", textEn: "One of the best delivery experiences I've had, will order again for sure", daysAgo: 21 },
  { name: "Sherif Adham", stars: 5, textAr: "المكان نضيف والطاقم لطيف جداً ومحترم", textEn: "The place is clean and the staff are very kind and respectful", daysAgo: 90 },
  { name: "فريدة محمد", stars: 5, textAr: "الطعم فوق الوصف، والتغليف أنيق جداً", textEn: "The taste is beyond words, and the packaging is very elegant", daysAgo: 180 },
  { name: "Dalia Fouad", stars: 5, textAr: "جربت الكابتشينو والتشيز كيك وكانوا رائعين", textEn: "Tried the cappuccino and cheesecake, both were fantastic", daysAgo: 4 },
  { name: "هدير مصطفى", stars: 5, textAr: "سعر مناسب مقابل الجودة العالية اللي بتقدمها", textEn: "Fair price for the high quality they offer", daysAgo: 21 },
  { name: "Peter Nabil", stars: 5, textAr: "فريق العمل بشوش ومتعاون جداً، تجربة ممتعة", textEn: "The staff are friendly and cooperative, a delightful experience", daysAgo: 90 },
  { name: "جهاد عادل", stars: 5, textAr: "الطلب وصل ساخن ومظبوط في معاده بالظبط", textEn: "The order arrived hot and right on time", daysAgo: 180 },
  { name: "Verina Nabil", stars: 5, textAr: "مكاني المفضل للقعدة مع صحابي، الجو حلو أوي", textEn: "My favorite spot to hang out with friends, the vibe is amazing", daysAgo: 4 },
  { name: "Mostafa Adel", stars: 5, textAr: "لسه بجرب حاجات جديدة من المنيو وكل حاجة بتعجبني", textEn: "Still trying new items from the menu and loving everything", daysAgo: 21 },
  { name: "Rana Magdy", stars: 5, textAr: "تصميم المكان جميل والإضاءة مريحة جداً للعين", textEn: "The place design is beautiful and the lighting is very comfortable", daysAgo: 90 },
  { name: "Sherif Adham", stars: 5, textAr: "خدمة العملاء ردت عليا بسرعة وحلت مشكلتي فوراً", textEn: "Customer service replied quickly and solved my issue instantly", daysAgo: 180 },
  { name: "Farida Mohamed", stars: 5, textAr: "الحلويات هنا مالهاش حل، خصوصاً التيراميسو", textEn: "The desserts here are unbeatable, especially the tiramisu", daysAgo: 4 },
  { name: "Dalia Fouad", stars: 5, textAr: "بطلب منهم كل أسبوع، جودة ثابتة من غير ما تقل", textEn: "I order from them every week, consistent quality that never drops", daysAgo: 21 },
  { name: "Hedeer Mostafa", stars: 5, textAr: "القهوة بتاعتهم من أحلى قهوة شربتها في حياتي", textEn: "Their coffee is some of the best I've ever had", daysAgo: 90 },
  { name: "Peter Nabil", stars: 5, textAr: "التطبيق سهل الاستخدام والطلب بياخد ثواني بس", textEn: "The app is easy to use and ordering takes just seconds", daysAgo: 180 },
  { name: "Jihad Adel", stars: 5, textAr: "عندهم عروض حلوة ومتجددة باستمرار", textEn: "They have great and constantly updated offers", daysAgo: 4 },
  { name: "Verina Nabil", stars: 5, textAr: "التوصيل كان أسرع من المتوقع بكتير", textEn: "Delivery was much faster than expected", daysAgo: 21 },
  { name: "Mostafa Adel", stars: 5, textAr: "جو المكان يخلي أي زيارة تبقى مميزة", textEn: "The atmosphere makes every visit feel special", daysAgo: 90 },
  { name: "رنا مجدي", stars: 5, textAr: "أول مرة أزور وحبيت التجربة من كل النواحي", textEn: "First visit and I loved the experience in every way", daysAgo: 180 },
  { name: "Sherif Adham", stars: 5, textAr: "النكهات مبتكرة وفيها لمسة مختلفة عن أي مكان تاني", textEn: "The flavors are creative with a unique twist you won't find elsewhere", daysAgo: 4 },
  { name: "فريدة محمد", stars: 5, textAr: "عيلتي كلها بقت بتطلب من هنا بقالها شهور", textEn: "My whole family has been ordering from here for months", daysAgo: 21 },
  { name: "Dalia Fouad", stars: 5, textAr: "الأسعار معقولة جداً بالنسبة لجودة المنتج", textEn: "Very reasonable prices for the product quality", daysAgo: 90 },
  { name: "هدير مصطفى", stars: 5, textAr: "حبيت إنهم بيردوا بسرعة على أي استفسار", textEn: "I loved how quickly they respond to any inquiry", daysAgo: 180 },
  { name: "Peter Nabil", stars: 5, textAr: "المشروبات الباردة منعشة جداً في الصيف", textEn: "The cold drinks are super refreshing in summer", daysAgo: 4 },
  { name: "جهاد عادل", stars: 5, textAr: "تجربة تستاهل كل نجومها، هرجع تاني أكيد", textEn: "An experience that deserves every star, I'll definitely be back", daysAgo: 21 },
  { name: "Verina Nabil", stars: 5, textAr: "بصراحة فاق توقعاتي، وربنا يوفقهم دايماً", textEn: "Honestly exceeded my expectations, wishing them continued success", daysAgo: 90 },
  { name: "Mostafa Adel", stars: 5, textAr: "المكان تحفة والطلبات بتوصل بسرعة، تجربة رهيبة 😍", textEn: "Lovely place, orders arrive fast — amazing experience 😍", daysAgo: 180 },
  { name: "Rana Magdy", stars: 5, textAr: "أحسن مطعم وافل وبان كيك جربته من ناحية الطعم والخدمة", textEn: "Best waffle & pancake restaurant I've tried in terms of taste and service", daysAgo: 4 },
  { name: "Sherif Adham", stars: 5, textAr: "بجد بحب المشروبات بتاعتهم، طلبت أكتر من مرة ومحصلش خيبة أمل", textEn: "I really love their drinks, ordered many times and never disappointed", daysAgo: 21 },
  { name: "Farida Mohamed", stars: 5, textAr: "خدمة سريعة واهتمام بالتفاصيل، شكراً فيتوار ❤", textEn: "Fast service and attention to detail, thank you Vitwar ❤", daysAgo: 90 },
  { name: "Dalia Fouad", stars: 5, textAr: "من أفضل تجارب التوصيل اللي جربتها، هطلب تاني أكيد", textEn: "One of the best delivery experiences I've had, will order again for sure", daysAgo: 180 },
  { name: "Hedeer Mostafa", stars: 5, textAr: "المكان نضيف والطاقم لطيف جداً ومحترم", textEn: "The place is clean and the staff are very kind and respectful", daysAgo: 4 },
  { name: "Peter Nabil", stars: 5, textAr: "الطعم فوق الوصف، والتغليف أنيق جداً", textEn: "The taste is beyond words, and the packaging is very elegant", daysAgo: 21 },
  { name: "Jihad Adel", stars: 5, textAr: "جربت الكابتشينو والتشيز كيك وكانوا رائعين", textEn: "Tried the cappuccino and cheesecake, both were fantastic", daysAgo: 90 },
  { name: "Verina Nabil", stars: 5, textAr: "سعر مناسب مقابل الجودة العالية اللي بتقدمها", textEn: "Fair price for the high quality they offer", daysAgo: 180 },
  { name: "Mostafa Adel", stars: 5, textAr: "فريق العمل بشوش ومتعاون جداً، تجربة ممتعة", textEn: "The staff are friendly and cooperative, a delightful experience", daysAgo: 4 },
  { name: "رنا مجدي", stars: 5, textAr: "الطلب وصل ساخن ومظبوط في معاده بالظبط", textEn: "The order arrived hot and right on time", daysAgo: 21 },
  { name: "Sherif Adham", stars: 5, textAr: "مكاني المفضل للقعدة مع صحابي، الجو حلو أوي", textEn: "My favorite spot to hang out with friends, the vibe is amazing", daysAgo: 90 },
  { name: "فريدة محمد", stars: 5, textAr: "لسه بجرب حاجات جديدة من المنيو وكل حاجة بتعجبني", textEn: "Still trying new items from the menu and loving everything", daysAgo: 180 },
  { name: "Dalia Fouad", stars: 5, textAr: "تصميم المكان جميل والإضاءة مريحة جداً للعين", textEn: "The place design is beautiful and the lighting is very comfortable", daysAgo: 4 },
  { name: "هدير مصطفى", stars: 5, textAr: "خدمة العملاء ردت عليا بسرعة وحلت مشكلتي فوراً", textEn: "Customer service replied quickly and solved my issue instantly", daysAgo: 21 },
  { name: "Peter Nabil", stars: 5, textAr: "الحلويات هنا مالهاش حل، خصوصاً التيراميسو", textEn: "The desserts here are unbeatable, especially the tiramisu", daysAgo: 90 },
  { name: "جهاد عادل", stars: 5, textAr: "بطلب منهم كل أسبوع، جودة ثابتة من غير ما تقل", textEn: "I order from them every week, consistent quality that never drops", daysAgo: 180 },
  { name: "Verina Nabil", stars: 5, textAr: "القهوة بتاعتهم من أحلى قهوة شربتها في حياتي", textEn: "Their coffee is some of the best I've ever had", daysAgo: 4 },
  { name: "Mostafa Adel", stars: 5, textAr: "التطبيق سهل الاستخدام والطلب بياخد ثواني بس", textEn: "The app is easy to use and ordering takes just seconds", daysAgo: 21 },
  { name: "Rana Magdy", stars: 5, textAr: "عندهم عروض حلوة ومتجددة باستمرار", textEn: "They have great and constantly updated offers", daysAgo: 90 },
  { name: "Sherif Adham", stars: 5, textAr: "التوصيل كان أسرع من المتوقع بكتير", textEn: "Delivery was much faster than expected", daysAgo: 180 },
  { name: "Farida Mohamed", stars: 5, textAr: "جو المكان يخلي أي زيارة تبقى مميزة", textEn: "The atmosphere makes every visit feel special", daysAgo: 4 },
  { name: "Dalia Fouad", stars: 5, textAr: "أول مرة أزور وحبيت التجربة من كل النواحي", textEn: "First visit and I loved the experience in every way", daysAgo: 21 },
  { name: "Hedeer Mostafa", stars: 5, textAr: "النكهات مبتكرة وفيها لمسة مختلفة عن أي مكان تاني", textEn: "The flavors are creative with a unique twist you won't find elsewhere", daysAgo: 90 },
  { name: "Peter Nabil", stars: 5, textAr: "عيلتي كلها بقت بتطلب من هنا بقالها شهور", textEn: "My whole family has been ordering from here for months", daysAgo: 180 },
  { name: "Jihad Adel", stars: 5, textAr: "الأسعار معقولة جداً بالنسبة لجودة المنتج", textEn: "Very reasonable prices for the product quality", daysAgo: 4 },
  { name: "Verina Nabil", stars: 5, textAr: "حبيت إنهم بيردوا بسرعة على أي استفسار", textEn: "I loved how quickly they respond to any inquiry", daysAgo: 21 },
  { name: "Mostafa Adel", stars: 5, textAr: "المشروبات الباردة منعشة جداً في الصيف", textEn: "The cold drinks are super refreshing in summer", daysAgo: 90 },
  { name: "رنا مجدي", stars: 5, textAr: "تجربة تستاهل كل نجومها، هرجع تاني أكيد", textEn: "An experience that deserves every star, I'll definitely be back", daysAgo: 180 },
  { name: "Sherif Adham", stars: 5, textAr: "بصراحة فاق توقعاتي، وربنا يوفقهم دايماً", textEn: "Honestly exceeded my expectations, wishing them continued success", daysAgo: 4 },
  { name: "نورهان طارق", stars: 4, textAr: "طعم جميل بس التغليف ممكن يتحسن شوية", textEn: "Great taste, packaging could be a bit better", daysAgo: 14 },
  { name: "Youssef Tarek", stars: 4, textAr: "جودة كويسة والأسعار مناسبة", textEn: "Good quality and fair prices", daysAgo: 60 },
  { name: "آية جمال", stars: 4, textAr: "تجربة حلوة عموماً، هكرر تاني", textEn: "Overall a nice experience, will come back", daysAgo: 150 },
  ...
  { name: "نور الهدى خالد", stars: 4, textAr: "المشروب لذيذ بس محتاج يكون أسخن شوية وقت التوصيل", textEn: "The drink is tasty but needs to be a bit hotter on delivery", daysAgo: 150 },
  ...
  { name: "آية جمال", stars: 4, textAr: "طعم جميل بس التغليف ممكن يتحسن شوية", textEn: "Great taste, packaging could be a bit better", daysAgo: 14 },
  { name: "Hazem Nasser", stars: 4, textAr: "جودة كويسة والأسعار مناسبة", textEn: "Good quality and fair prices", daysAgo: 60 },
  { name: "أحمد سامي", stars: 4, textAr: "تجربة حلوة عموماً، هكرر تاني", textEn: "Overall a nice experience, will come back", daysAgo: 150 },
  { name: "Adham Fekry", stars: 4, textAr: "المكان كويس بس مواعيد التوصيل ممكن تتظبط أكتر", textEn: "The place is good but delivery times could be more consistent", daysAgo: 3 },
  { name: "نور الهدى خالد", stars: 4, textAr: "الطعم حلو بس كنت متوقع كمية أكبر شوية", textEn: "Nice taste, though I expected a slightly bigger portion", daysAgo: 14 },
  { name: "Hany Fawzy", stars: 4, textAr: "خدمة لطيفة لكن الزحمة بتأخر الطلب أحياناً", textEn: "Nice service but the crowd sometimes delays the order", daysAgo: 60 },
  { name: "سيف الدين", stars: 4, textAr: "المشروب لذيذ بس محتاج يكون أسخن شوية وقت التوصيل", textEn: "The drink is tasty but needs to be a bit hotter on delivery", daysAgo: 150 },
  { name: "Nourhan Tarek", stars: 4, textAr: "عموماً تجربة كويسة وهعاود اطلب تاني", textEn: "Overall a good experience and I'll order again", daysAgo: 3 },
  { name: "Youssef Tarek", stars: 4, textAr: "الأسعار حلوة بس ممكن يزودوا خيارات المنيو", textEn: "Good prices but menu options could be expanded", daysAgo: 14 },
  { name: "Aya Gamal", stars: 4, textAr: "حبيت المكان لكن مفيش أماكن جلوس كتير", textEn: "Liked the place but there isn't a lot of seating", daysAgo: 60 },
  { name: "Hazem Nasser", stars: 4, textAr: "التطبيق شغال كويس عدا شوية بطء أحياناً", textEn: "The app works well aside from occasional slowness", daysAgo: 150 },
  { name: "Ahmed Samy", stars: 4, textAr: "الطلب كان مظبوط بس اتأخر شوية عن الميعاد", textEn: "The order was correct but arrived a bit late", daysAgo: 3 },
  { name: "Adham Fekry", stars: 4, textAr: "الطعم جيد جداً، بس محتاجين يزودوا تنوع النكهات", textEn: "Taste is very good, just needs more flavor variety", daysAgo: 14 },
  { name: "Nour Elhoda Khaled", stars: 4, textAr: "خدمة جيدة وسعر مناسب، تجربة تستاهل التكرار", textEn: "Good service and fair price, worth repeating", daysAgo: 60 },
  { name: "Hany Fawzy", stars: 4, textAr: "عجبني الاهتمام بالتفاصيل رغم بعض التأخير البسيط", textEn: "I liked the attention to detail despite a minor delay", daysAgo: 150 },
  { name: "Seif Eldin", stars: 4, textAr: "النظافة كويسة والطاقم متعاون بشكل عام", textEn: "Cleanliness is good and staff are generally cooperative", daysAgo: 3 },
  { name: "نورهان طارق", stars: 4, textAr: "تجربة مرضية، وفي مجال بسيط للتحسين في التغليف", textEn: "Satisfying experience, with slight room to improve packaging", daysAgo: 14 },
  { name: "Youssef Tarek", stars: 4, textAr: "الطعم قريب من الممتاز، محتاج بس لمسة نهائية", textEn: "Taste is close to excellent, just needs a final touch", daysAgo: 60 },
  { name: "آية جمال", stars: 4, textAr: "سعر معقول وجودة كويسة، هجربه تاني قريب", textEn: "Reasonable price and good quality, I'll try it again soon", daysAgo: 150 },
  { name: "Hazem Nasser", stars: 4, textAr: "المكان مريح والخدمة سريعة في أغلب الأوقات", textEn: "The place is comfortable and service is fast most of the time", daysAgo: 3 },
  { name: "أحمد سامي", stars: 4, textAr: "طعم جميل بس التغليف ممكن يتحسن شوية", textEn: "Great taste, packaging could be a bit better", daysAgo: 14 },
  { name: "Adham Fekry", stars: 4, textAr: "جودة كويسة والأسعار مناسبة", textEn: "Good quality and fair prices", daysAgo: 60 },
  { name: "نور الهدى خالد", stars: 4, textAr: "تجربة حلوة عموماً، هكرر تاني", textEn: "Overall a nice experience, will come back", daysAgo: 150 },
  { name: "Hany Fawzy", stars: 4, textAr: "المكان كويس بس مواعيد التوصيل ممكن تتظبط أكتر", textEn: "The place is good but delivery times could be more consistent", daysAgo: 3 },
  { name: "سيف الدين", stars: 4, textAr: "الطعم حلو بس كنت متوقع كمية أكبر شوية", textEn: "Nice taste, though I expected a slightly bigger portion", daysAgo: 14 },
  { name: "Nourhan Tarek", stars: 4, textAr: "خدمة لطيفة لكن الزحمة بتأخر الطلب أحياناً", textEn: "Nice service but the crowd sometimes delays the order", daysAgo: 60 },
  { name: "Youssef Tarek", stars: 4, textAr: "المشروب لذيذ بس محتاج يكون أسخن شوية وقت التوصيل", textEn: "The drink is tasty but needs to be a bit hotter on delivery", daysAgo: 150 },
  { name: "Aya Gamal", stars: 4, textAr: "عموماً تجربة كويسة وهعاود اطلب تاني", textEn: "Overall a good experience and I'll order again", daysAgo: 3 },
  { name: "Hazem Nasser", stars: 4, textAr: "الأسعار حلوة بس ممكن يزودوا خيارات المنيو", textEn: "Good prices but menu options could be expanded", daysAgo: 14 },
  { name: "Ahmed Samy", stars: 4, textAr: "حبيت المكان لكن مفيش أماكن جلوس كتير", textEn: "Liked the place but there isn't a lot of seating", daysAgo: 60 },
  { name: "Adham Fekry", stars: 4, textAr: "التطبيق شغال كويس عدا شوية بطء أحياناً", textEn: "The app works well aside from occasional slowness", daysAgo: 150 },
  { name: "Nour Elhoda Khaled", stars: 4, textAr: "الطلب كان مظبوط بس اتأخر شوية عن الميعاد", textEn: "The order was correct but arrived a bit late", daysAgo: 3 },
  { name: "Hany Fawzy", stars: 4, textAr: "الطعم جيد جداً، بس محتاجين يزودوا تنوع النكهات", textEn: "Taste is very good, just needs more flavor variety", daysAgo: 14 },
  { name: "Seif Eldin", stars: 4, textAr: "خدمة جيدة وسعر مناسب، تجربة تستاهل التكرار", textEn: "Good service and fair price, worth repeating", daysAgo: 60 },
  { name: "نورهان طارق", stars: 4, textAr: "عجبني الاهتمام بالتفاصيل رغم بعض التأخير البسيط", textEn: "I liked the attention to detail despite a minor delay", daysAgo: 150 },
  { name: "Youssef Tarek", stars: 4, textAr: "النظافة كويسة والطاقم متعاون بشكل عام", textEn: "Cleanliness is good and staff are generally cooperative", daysAgo: 3 },
  { name: "آية جمال", stars: 4, textAr: "تجربة مرضية، وفي مجال بسيط للتحسين في التغليف", textEn: "Satisfying experience, with slight room to improve packaging", daysAgo: 14 },
  { name: "Hazem Nasser", stars: 4, textAr: "الطعم قريب من الممتاز، محتاج بس لمسة نهائية", textEn: "Taste is close to excellent, just needs a final touch", daysAgo: 60 },
  { name: "أحمد سامي", stars: 4, textAr: "سعر معقول وجودة كويسة، هجربه تاني قريب", textEn: "Reasonable price and good quality, I'll try it again soon", daysAgo: 150 },
  { name: "Adham Fekry", stars: 4, textAr: "المكان مريح والخدمة سريعة في أغلب الأوقات", textEn: "The place is comfortable and service is fast most of the time", daysAgo: 3 },
  { name: "نور الهدى خالد", stars: 4, textAr: "طعم جميل بس التغليف ممكن يتحسن شوية", textEn: "Great taste, packaging could be a bit better", daysAgo: 14 },
  { name: "Hany Fawzy", stars: 4, textAr: "جودة كويسة والأسعار مناسبة", textEn: "Good quality and fair prices", daysAgo: 60 },
  { name: "سيف الدين", stars: 4, textAr: "تجربة حلوة عموماً، هكرر تاني", textEn: "Overall a nice experience, will come back", daysAgo: 150 },
  { name: "Nourhan Tarek", stars: 4, textAr: "المكان كويس بس مواعيد التوصيل ممكن تتظبط أكتر", textEn: "The place is good but delivery times could be more consistent", daysAgo: 3 },
  { name: "Youssef Tarek", stars: 4, textAr: "الطعم حلو بس كنت متوقع كمية أكبر شوية", textEn: "Nice taste, though I expected a slightly bigger portion", daysAgo: 14 },
  { name: "Aya Gamal", stars: 4, textAr: "خدمة لطيفة لكن الزحمة بتأخر الطلب أحياناً", textEn: "Nice service but the crowd sometimes delays the order", daysAgo: 60 },
  { name: "Hazem Nasser", stars: 4, textAr: "المشروب لذيذ بس محتاج يكون أسخن شوية وقت التوصيل", textEn: "The drink is tasty but needs to be a bit hotter on delivery", daysAgo: 150 },
  { name: "Ahmed Samy", stars: 4, textAr: "عموماً تجربة كويسة وهعاود اطلب تاني", textEn: "Overall a good experience and I'll order again", daysAgo: 3 },
  { name: "Adham Fekry", stars: 4, textAr: "الأسعار حلوة بس ممكن يزودوا خيارات المنيو", textEn: "Good prices but menu options could be expanded", daysAgo: 14 },
  { name: "Nour Elhoda Khaled", stars: 4, textAr: "حبيت المكان لكن مفيش أماكن جلوس كتير", textEn: "Liked the place but there isn't a lot of seating", daysAgo: 60 },
  { name: "Hany Fawzy", stars: 4, textAr: "التطبيق شغال كويس عدا شوية بطء أحياناً", textEn: "The app works well aside from occasional slowness", daysAgo: 150 },
  { name: "Seif Eldin", stars: 4, textAr: "الطلب كان مظبوط بس اتأخر شوية عن الميعاد", textEn: "The order was correct but arrived a bit late", daysAgo: 3 },
  { name: "نورهان طارق", stars: 4, textAr: "الطعم جيد جداً، بس محتاجين يزودوا تنوع النكهات", textEn: "Taste is very good, just needs more flavor variety", daysAgo: 14 },
  { name: "Youssef Tarek", stars: 4, textAr: "خدمة جيدة وسعر مناسب، تجربة تستاهل التكرار", textEn: "Good service and fair price, worth repeating", daysAgo: 60 },
  { name: "آية جمال", stars: 4, textAr: "عجبني الاهتمام بالتفاصيل رغم بعض التأخير البسيط", textEn: "I liked the attention to detail despite a minor delay", daysAgo: 150 },
  { name: "Karim Hossam", stars: 3, textAr: "الطلب اتأخر شوية بس الطعم عوّض", textEn: "Order was a bit late but the taste made up for it", daysAgo: 7 },
...
function renderLocationModal() {
  ...
  if (iframe) iframe.src = (branch && branch.locationMapUrl) ? branch.locationMapUrl : "";
...
function updateGoogleAuthUI() {
  const icon = document.getElementById("browseGoogleAuthIcon");
...
function renderCategories() {
  ...
  bar.innerHTML = all
    .map(
      (c) =>
        `<button class="category-chip tap-fx ${c.id === OFFERS_TAB_ID ? "category-chip-offer" : ""} ${state.activeCategory === c.id ? "active" : ""}" data-cat="${c.id}">${c.id === "all" || c.id === OFFERS_TAB_ID ? c.name : itemDisplayName(c)}</button>`
    )
    .join("");
...
function renderProducts() {
  ...
  grid.innerHTML = list
    ...
    <div class="product-card">
      <div class="img-wrap">
        <img src="${p.image}" alt="${itemDisplayName(p)}" onerror="this.src='images/logo.png'"/>
        ${isOffersTab || p.isOffer ? `<span class="offer-badge">${t("offerBadge")}</span>` : ""}
        ${p.available === false ? `<span class="unavailable-badge">${t("unavailableBadge")}</span>` : ""}
      </div>
      <div class="info">
        ...
        <div class="row">
          ...
          <button class="glass-btn tap-fx" style="padding:8px 16px" data-open="${p.id}" data-offer="${isOffersTab ? "1" : "0"}" ${p.available === false ? "disabled" : ""}>${t("chooseBtn")}</button>
        </div>
      </div>
    </div>
  `;
  ...
  grid.querySelectorAll("[data-open]").forEach((btn) => {
    btn.addEventListener("click", (e) => openProductModal(btn.dataset.open, e.currentTarget, btn.dataset.offer === "1"));
  });
...
function renderCheckoutStep2() {
  ...
  const typeLabel = {
    cafe: `${t("orderTypeCafe")} ☕`,
    delivery: `${t("orderTypeDelivery")} 🛵`,
    pickup: `${t("orderTypePickup")} 🏃`,
  }[state.checkoutType];
  step2.innerHTML = `
    <div class="option-box">
      ...
      <div class="field">
        ...
        <div class="payment-method-grid">
          <button type="button" class="glass-btn-secondary glass-btn tap-fx payment-method-btn" data-payment="كاش">${t("paymentCash")}</button>
          <button type="button" class="glass-btn-secondary glass-btn tap-fx payment-method-btn" data-payment="انستاباي">${t("paymentInstapay")}</button>
        </div>
      </div>
      <div class="field">
...
(function initInstallFlow() {
  ...
  document.getElementById("branchInstallBtn")?.addEventListener("click", () => {
    openInstallSheet();
  });
...
function updateMessagesBadge() {
  ...
  const hasUnread = customerMessagesList.some((m) => (m.createdAt || 0) > seen);
...
function renderCustomerMessagesInbox() {
  ...
  if (!box) return;
  if (!customerMessagesList.length) {
