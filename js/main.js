...
const SEED_REVIEWS = [
  ...
  { name: "هدير مصطفى", stars: 5, textAr: "بجد بحب الحلويات بتاعتهم، طلبت أكتر من مرة ومحصلش خيبة أمل", textEn: "I really love their desserts, ordered many times and never disappointed", daysAgo: 21 },
  ...
  { name: "Rana Magdy", stars: 5, textAr: "جربت البان كيك والتشيز كيك وكانوا رائعين", textEn: "Tried the pancakes and cheesecake, both were fantastic", daysAgo: 90 },
  ...
  { name: "Sherif Adham", stars: 5, textAr: "الكنافة بتاعتهم من أحلى كنافة اكلتها في حياتي", textEn: "Their kunafa is some of the best I've ever had", daysAgo: 4 },
  ...
  { name: "Farida Mohamed", stars: 5, textAr: "البراونيز بتاعتهم لذيذة جداً في أي وقت", textEn: "Their brownies are amazing any time", daysAgo: 90 },
  ...
  { name: "Verina Nabil", stars: 5, textAr: "بجد بحب الحلويات بتاعتهم، طلبت أكتر من مرة ومحصلش خيبة أمل", textEn: "I really love their desserts, ordered many times and never disappointed", daysAgo: 180 },
  ...
  { name: "Dalia Fouad", stars: 5, textAr: "جربت البان كيك والتشيز كيك وكانوا رائعين", textEn: "Tried the pancakes and cheesecake, both were fantastic", daysAgo: 4 },
  ...
  { name: "Hedeer Mostafa", stars: 5, textAr: "الكنافة بتاعتهم من أحلى كنافة اكلتها في حياتي", textEn: "Their kunafa is some of the best I've ever had", daysAgo: 90 },
  ...
  { name: "Peter Nabil", stars: 5, textAr: "البراونيز بتاعتهم لذيذة جداً في أي وقت", textEn: "Their brownies are amazing any time", daysAgo: 4 },
  ...
  { name: "Sherif Adham", stars: 5, textAr: "بجد بحب الحلويات بتاعتهم، طلبت أكتر من مرة ومحصلش خيبة أمل", textEn: "I really love their desserts, ordered many times and never disappointed", daysAgo: 21 },
  ...
  { name: "Jihad Adel", stars: 5, textAr: "جربت البان كيك والتشيز كيك وكانوا رائعين", textEn: "Tried the pancakes and cheesecake, both were fantastic", daysAgo: 90 },
  ...
  { name: "Verina Nabil", stars: 5, textAr: "الكنافة بتاعتهم من أحلى كنافة اكلتها في حياتي", textEn: "Their kunafa is some of the best I've ever had", daysAgo: 4 },
  ...
  { name: "Mostafa Adel", stars: 5, textAr: "البراونيز بتاعتهم لذيذة جداً في أي وقت", textEn: "Their brownies are amazing any time", daysAgo: 90 },
  ...
  { name: "سيف الدين", stars: 4, textAr: "الطبق وصل سخن ولذيذ، بس ياريت التوصيل يكون أسرع شوية", textEn: "The dish arrived hot and delicious, just wish delivery was a bit faster", daysAgo: 150 },
  ...
  { name: "Youssef Tarek", stars: 4, textAr: "الطبق وصل سخن ولذيذ، بس ياريت التوصيل يكون أسرع شوية", textEn: "The dish arrived hot and delicious, just wish delivery was a bit faster", daysAgo: 150 },
  ...
  { name: "Hazem Nasser", stars: 4, textAr: "الطبق وصل سخن ولذيذ، بس ياريت التوصيل يكون أسرع شوية", textEn: "The dish arrived hot and delicious, just wish delivery was a bit faster", daysAgo: 150 },
...
// ---------- تأكيد اختيار طريقة الدفع (Blur + GIF في النص) ----------
// مدة عرض الأنيميشن = طول دورة الـ GIF الواحدة (30 فريم بمعدل 30 فريم/ث تقريبًا)
const PAYMENT_CONFIRM_GIF_MS = 900;
let paymentConfirmTimer = null;
function showPaymentConfirmFx(method) {
  const overlay = document.getElementById("paymentConfirmOverlay");
  const box = document.getElementById("paymentConfirmBox");
  if (!overlay || !box) return;
  const src = method === "انستاباي" ? "images/icons/emoji-instapay.gif" : "images/icons/emoji-cash.gif";
  // إعادة تحميل الـ GIF من أول فريم في كل مرة يتفتح فيها (query string بتاريخ مختلف)
  box.innerHTML = `<img src="${src}?play=${Date.now()}" alt="" />`;
  overlay.classList.add("show");
  clearTimeout(paymentConfirmTimer);
  paymentConfirmTimer = setTimeout(() => {
    overlay.classList.remove("show");
    box.innerHTML = "";
  }, PAYMENT_CONFIRM_GIF_MS);
}
...
function renderCheckoutStep2() {
  ...
  step2.querySelectorAll(".payment-method-btn").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      showPaymentConfirmFx(btn.dataset.payment);
    });
  });
