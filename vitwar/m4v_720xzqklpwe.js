...
function updateMyOrdersBadge() {
  ...
  if (!badge) return;
  const active = (state.customerOrders || []).filter((o) => !o.receivedByCustomer).length;
    ...
    <div class="my-order-card">
      ...
      <div class="my-order-card-top">
        <div class="my-order-stage" data-track-order="${o.id}" data-track-branch="${o.branchId}">
          <div class="my-order-mini-ring" style="--ring-pct:${pct}"></div>
        </div>
        <span class="my-order-stage" data-track-order="${o.id}" data-track-branch="${o.branchId}">${stageLabel}</span>
        <span class="my-order-total">${o.total} ${t("currency")}</span>
      </div>
      <div class="my-order-actions">
        <button class="glass-btn tap-fx" data-track-order="${o.id}" data-track-branch="${o.branchId}">${t("orderTrackingTitle")}</button>
...
function renderOrderTrackingState(branchId, order) {
  ...
  const ring = document.getElementById("orderTrackingRing");
