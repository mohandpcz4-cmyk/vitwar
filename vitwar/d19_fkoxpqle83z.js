...
const I18N = {
  ar: {
    ...
    myAccountGuestName: "عميل فيتوار",
    myAccountOrdersTitle: "طلباتي",
    myAccountNoOrders: "لسه معملتش أي أوردر",
    myAccountBack: "رجوع",
    myAccountLogout: "تسجيل الخروج",
    myAccountLoginTab: "تسجيل الدخول",
    myAccountSignupTab: "حساب جديد",
    myAccountPasswordLabel: "كلمة المرور",
    myAccountPasswordPlaceholder: "اكتب كلمة المرور",
    myAccountLoginBtn: "دخول",
    myAccountSignupBtn: "إنشاء الحساب",
    myAccountOr: "أو",
    myAccountErrPassword: "من فضلك اكتب كلمة المرور",
    myAccountErrPasswordLen: "كلمة المرور لازم تكون 6 أحرف على الأقل",
    myAccountErrName: "من فضلك اكتب اسمك",
    myAccountErrLogin: "رقم الموبايل أو كلمة المرور غير صحيحة",
    myAccountErrSignup: "حصل خطأ أثناء إنشاء الحساب، حاول تاني",
    myAccountErrPhoneUsed: "رقم الموبايل ده مسجل بحساب قبل كده",
    myAccountLoginSuccess: "تم تسجيل الدخول بنجاح ✅",
    myAccountSignupSuccess: "تم إنشاء حسابك بنجاح ✅",
    myAccountReorderBtn: "إعادة الطلب 🔁",
    myAccountFavoritesTitle: "المفضلة",
    myAccountNoFavorites: "لسه معملتش أي منتج مفضل",
    favoritesToggle: "إضافة/إزالة من المفضلة",
    favoritesLoginRequired: "سجّل دخولك الأول عشان تضيف للمفضلة",
    favoritesErrorToast: "حصل خطأ، حاول تاني",
    reorderAddedToast: "تمت إضافة {count} صنف للسلة ✅",
    reorderUnavailableToast: "الأصناف دي مش متاحة حاليًا: {names}",
    footer: "جميع الحقوق محفوظة لـ Vitwar © 2026 ",

    categoryAll: "الكل",
    categoryOffers: "🎁 العروض",
    categoryBirthday: "🎂 أعياد الميلاد",
    categoryAddons: "✨ الإضافات",
    noProductsInCategory: "لا يوجد أصناف في هذا التصنيف حاليًا",
    noOffersInCategory: "لا يوجد عروض حاليًا",
    noBirthdayInCategory: "لا يوجد عروض أعياد ميلاد حاليًا",
    ...
    openInstapayLinkBtn: "افتح رابط الدفع",
  ...
  en: {
    ...
    myAccountGuestName: "Vitwar Customer",
    myAccountOrdersTitle: "My Orders",
    myAccountNoOrders: "You haven't placed any orders yet",
    myAccountBack: "Back",
    myAccountLogout: "Log out",
    myAccountLoginTab: "Log in",
    myAccountSignupTab: "New account",
    myAccountPasswordLabel: "Password",
    myAccountPasswordPlaceholder: "Enter your password",
    myAccountLoginBtn: "Log in",
    myAccountSignupBtn: "Create account",
    myAccountOr: "Or",
    myAccountErrPassword: "Please enter your password",
    myAccountErrPasswordLen: "Password must be at least 6 characters",
    myAccountErrName: "Please enter your name",
    myAccountErrLogin: "Incorrect phone number or password",
    myAccountErrSignup: "Something went wrong creating your account, please try again",
    myAccountErrPhoneUsed: "This phone number is already registered",
    myAccountLoginSuccess: "Logged in successfully ✅",
    myAccountSignupSuccess: "Your account was created successfully ✅",
    myAccountReorderBtn: "Reorder 🔁",
    myAccountFavoritesTitle: "Favorites",
    myAccountNoFavorites: "You haven't favorited any items yet",
    favoritesToggle: "Add/remove from favorites",
    favoritesLoginRequired: "Please log in first to add favorites",
    favoritesErrorToast: "Something went wrong, please try again",
    reorderAddedToast: "{count} item(s) added to your cart ✅",
    reorderUnavailableToast: "These items are no longer available: {names}",
    ...
    noBirthdayInCategory: "No birthday items available right now",
